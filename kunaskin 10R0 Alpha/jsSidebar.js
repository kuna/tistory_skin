...
jm.welcomeTime = 2000;				/* first welcoming message showtime */
...
jm.Init = function () {
	...
	//jm.addCharacter( "char31.png", "char32.png", "char33.png" );
	//jm.addCharacter( "char_mizuki_1.png", "char_mizuki_2.png", "char_mizuki_3.png" );
	//jm.addCharacter( "char_chihiro_1.png", "char_chihiro_2.png", "char_chihiro_3.png" );
	//jm.addCharacter( "char_miki_1.png", "char_miki_2.png", "char_miki_3.png" );
	...
	// welcoming message part
	//$('#js_msgCover').css('opacity', 0);
	//$('#js_charCover').css('opacity', 0);
}
